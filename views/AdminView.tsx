...
type AdminView = 'dashboard' | 'products' | 'categories' | 'orders' | 'labeling' | 'settings';
...
const AdminLayout: React.FC = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (['products', 'categories', 'orders', 'labeling', 'settings', 'dashboard'].includes(hash)) {
