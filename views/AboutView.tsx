  ...
  const socialLinks = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon: (
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.83l-1.42 6.69c-.14.65-.54.81-1.08.5l-3.23-2.38-1.55 1.49c-.17.17-.31.31-.61.31l.22-3.28 5.8-5.26c.25-.22-.05-.34-.38-.12L7.33 11.44 4.23 10.4c-.65-.21-.65-.68.12-.89l10.1-3.95c.55-.21 1.04.14.86.87z" />
            </svg>
        )
      },
      {
