  ...
  const socialLinks = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon: (
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.17.9-.494 1.2-.822 1.23-.696.065-1.225-.46-1.9-1.088-1.055-.975-1.64-1.574-2.6-2.524-.995-.98-1.97-1.942-1.85-2.068.12-.126.36-.027.616-.273.257-.246 1.77-1.684 1.77-1.684s.2-.17.02-.33-.356-.14-.48-.12c-.126.02-2.125 1.39-2.83 1.83-.69.43-1.22.6-1.55.58-.33-.02-.53-.14-.53-.14s-.3-.21-.21-.48c.02-.05.05-.1.08-.14.72-.77 7.87-7.25 7.87-7.25s.2-.17.34-.17z" />
            </svg>
        )
      },
      {
