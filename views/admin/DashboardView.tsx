    ...
    <div className="animate-view-enter space-y-8">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <a href="/admin#products" className="bg-slate-50 p-4 rounded-lg hover:bg-slate-100 transition-colors">
                <p className="font-bold text-slate-900">Kelola Produk</p>
                <p className="text-xs text-slate-500">Tambah, edit, atau hapus produk.</p>
            </a>
             <a href="/admin#categories" className="bg-slate-50 p-4 rounded-lg hover:bg-slate-100 transition-colors">
             ...
             <a href="/admin#settings" className="bg-slate-50 p-4 rounded-lg hover:bg-slate-100 transition-colors">
