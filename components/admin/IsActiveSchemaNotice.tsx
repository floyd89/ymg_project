...
const IsActiveSchemaNotice: React.FC<{ onDismiss?: () => void }> = ({ onDismiss }) => (
    ...
    <div className="flex justify-between items-start">
        <div>
            ...
            <p className="text-sm mt-2 mb-4">
              Fitur baru untuk mengaktifkan/menonaktifkan produk memerlukan kolom <strong>"isActive"</strong> di tabel <code>products</code> Anda, tetapi kolom tersebut tidak ditemukan.
            </p>
        </div>
        {onDismiss && (
    ...
    <div className="text-xs space-y-3 bg-yellow-100 p-3 rounded-md">
      <div>
          ...
          <pre className="mt-2 text-[10px] bg-yellow-200 text-yellow-900 p-2 rounded-md overflow-x-auto">
            <code>
{`-- Menambahkan kolom 'isActive' untuk mengontrol visibilitas produk
...
-- Komentar: Perintah ini aman dijalankan berkali-kali.`}
          ...
          <p className="mt-2 text-[10px] italic">Setelah menjalankan SQL, silakan refresh halaman ini. Fitur toggle akan berfungsi.</p>
      </div>
    </div>
  </div>
);

export default IsActiveSchemaNotice;
