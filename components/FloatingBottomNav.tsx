...
const FloatingBottomNav: React.FC<FloatingBottomNavProps> = ({ onHomeClick, onAboutClick, onAddToCart, onGoToCart, cartItemCount, activeProduct, activeVariant }) => {
    ...
    return (
      <div className="fixed bottom-0 left-0 w-full z-50 md:hidden bg-white/95 backdrop-blur-xl border-t border-slate-100 shadow-[0_-5px_30px_rgba(0,0,0,0.05)]">
        <div className="flex items-center p-3 gap-3">
          ...
          >
            {isReadyToBuy ? 'Tambah ke Keranjang' : 'Pilih Varian Dulu'}
          </button>
        </div>
      </div>
    );
